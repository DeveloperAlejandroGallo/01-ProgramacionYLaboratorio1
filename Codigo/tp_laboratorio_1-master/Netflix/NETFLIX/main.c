...
int main()
{
    ...
    eCliente clientes[C];
    eLoser loosers[S];
    eClientesSeries clientesSeries[CS];

    cargarSeries(series);
    cargarClientes(clientes);
    cargarClientesSeries(clientes,series,clientesSeries);
    ...
    while(seguir=='s')
    {
        ...
        switch(opcion)
        {
            case 2:
                ...
                break;
            case 3:
                mostrarClientesConSerie(clientes, series, clientesSeries,C,S, CS);
                break;
            case 4:
                mostrarSeriesConClientes(clientes,series,clientesSeries,C,S,CS);
                break;
            case 5:
                ...
                if(iBuscado != -1)
                {
                    ...
                    imprimirClientesDeUnaSerie(clientes, series[iBuscado].idSerie, clientesSeries,  C, CS);
                }
                else
